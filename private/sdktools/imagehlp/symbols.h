...
#define LookupFunctionEntryAxp32(a,b) NULL
#define LookupFunctionEntryAxp64(a,b) NULL
#define LookupFunctionEntryIA64(a,b) NULL
#define GetAlphaFunctionEntryFromDebugInfo(a,b) NULL
...
#else
#define GetPdbTypeInfo(a,b,c,d,e,f) FALSE
#endif
