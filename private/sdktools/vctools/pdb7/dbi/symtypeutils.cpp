...
unsigned
CbGetNumericData ( const void * pv, DWORD & dwVal ); //mretype.cpp 
...
wchar_t *SZNameFromTSRecord(PTYPE ptype, __out_ecount(cchNameBuf) wchar_t *wszNameBuf, size_t cchNameBuf)
{
