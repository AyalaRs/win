...
public:
    static IPDBError * PDBCALL Create( PDB *ppdb ) { 
        return new CPDBErrorDefault;
    }
    static IPDBError * PDBCALL CreateHandler( PDB *ppdb ) { 
        return s_pfnPDBErrorCreate( ppdb );
    }
    static BOOL PDBCALL SetCreateHandler( PfnPDBErrorCreate pfn ) {
        if (pfn == NULL) {
            // set it back to default
            pfn = (PfnPDBErrorCreate)&CPDBErrorDefault::Create;
        }
...
PfnPDBErrorCreate CPDBErrorDefault::s_pfnPDBErrorCreate = (PfnPDBErrorCreate)&CPDBErrorDefault::Create;
...
#ifndef _HASH_SHA256_ //PDB1::ResetGUID
{
    return FALSE;
}
#else
...
BOOL PDBCopy::CopyPrivateSymbols(
    Mod *pmodIn,
    Mod *pmodOut)
#ifndef _HASH_SHA256_ //PDBCopy::CopyPrivateSymbols
{
    return FALSE;
}
#else
...
#ifndef _HASH_SHA256_ //PDBCopy::CopyMods
{
    __debugbreak();
...
#ifndef _HASH_SHA256_ //PDBCopy::ProcessModInMiniPDB
{
	return FALSE;
}
#else
...
#ifndef _HASH_SHA256_ //PDBCopy::RegisterPDBMapping
{
	return FALSE;
}
#else
